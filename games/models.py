...
def game_main_image_path(instance, filename):
    return f"{instance.slug}/main_image/{filename}"


class Game(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    title = models.CharField(
        max_length=255, blank=False, null=False, verbose_name="Название", db_index=True
    )
    articule = models.CharField(blank=True, null=True, verbose_name="Артикул")
    url_u = models.CharField(
        max_length=255, blank=True, null=False, verbose_name="URL_U"
    )
    url_t = models.CharField(
        max_length=255, blank=True, null=False, verbose_name="URL_T"
    )
    slug = models.SlugField(max_length=255, unique=True, blank=True, verbose_name="Slug")
    main_image_url = models.ImageField(
        blank=False,
        null=False,
        verbose_name="Главное изображение(URL)",
        max_length=500,
        upload_to=game_main_image_path,
    )
    ...
    subtitle = models.ManyToManyField(
        "Language", blank=True, related_name="subtitle_games", verbose_name="Субтитры"
    )
    ...
    publishers = models.ManyToManyField(
        "Publisher", blank=True, related_name="publisher_game", verbose_name="Издатель"
    )
...
class Image(models.Model):
    ...
    image_url = models.CharField(
        max_length=255, blank=False, null=False, verbose_name="URL изображения"
    )
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="Дата создания")
    updated_at = models.DateTimeField(auto_now=True, verbose_name="Дата обновления")
...
class Language(models.Model):
    ...
    consoles = models.ForeignKey(
        Consoles, on_delete=models.CASCADE, verbose_name="Консоли"
    )
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="Дата создания")
    updated_at = models.DateTimeField(auto_now=True, verbose_name="Дата обновления")
...
class Categories(models.Model):
    ...
    category = models.CharField(
        max_length=50, blank=True, null=True, verbose_name="Категория"
    )
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="Дата создания")
    updated_at = models.DateTimeField(auto_now=True, verbose_name="Дата обновления")
...
class Publisher(models.Model):
    ...
    publisher = models.CharField(
        max_length=50, blank=True, null=True, verbose_name="Издатель"
    )
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="Дата создания")
    updated_at = models.DateTimeField(auto_now=True, verbose_name="Дата обновления")
...
class Price(models.Model):
    ...
    is_active = models.BooleanField(
        default=True, blank=False, null=False, verbose_name="Активен"
    )
    consoles = models.ForeignKey(
        Consoles, on_delete=models.CASCADE, verbose_name="Консоли"
    )
    ...
    def __str__(self):
        return f"{self.payment_type} | {self.price} ₽"
